...
1) Gaining experience with large datasets
2) Practise "cleaning"  of data.
3) Learning how to use different Machine Learning Models

Link to competition: https://www.kaggle.com/c/facebook-recruiting-iv-human-or-bot/data

**Features used in this model:** <br>
